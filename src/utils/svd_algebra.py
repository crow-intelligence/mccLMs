...
try:
    from src.utils.count_skipgrams import count_skipgrams
except Exception as e:
    from utils.count_skipgrams import count_skipgrams
...
class SVDAlgebra:
    ...
    def read_corpus(self, corpus_dir):
        ...
        txts = [f for f in listdir(corpus_dir) if isfile(join(corpus_dir, f))]
        for txt in txts:
